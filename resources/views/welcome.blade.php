    ...
    <header>
        <div class="container-fluid">
            <div id="welcome-section" class="intro-text">
                <div class="logo">
                    <img src="http://localhost:8000/logoperpustakaan.jpg" alt="Logo" class="light-background" style="width: 100px;">
                </div>
                <div class="intro-lead-in">Selamat Datang Di Perpustakaan Digital</div>
                <h2>Selamat Datang di Perpustakaan Digital Kami!
                    apatkan akses ke koleksi terbaru dari berbagai genre, penulis terkenal, danto[ik menarik.
                </h2>
